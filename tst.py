...
while True:
    if temp == False and datetime.now().strftime('%T') == '15:20:00':
        temp = True
        driver = webdriver.Chrome('//home//ubuntu//bot1//bo1//jsn//ideal-enigma//chromedriver')
                ...
                if elem1.value_of_css_property('display') != 'block':
                    ...
                    for b in all_options1:
                        ...
                        for element in driver.find_elements_by_id("tabdata"):
                            group = b.text
                            with open('//home//ubuntu//bot1//bo1//jsn//Rasp//' + date + '_' + group.replace(' ', '') + '.txt', 'w+') as f:
